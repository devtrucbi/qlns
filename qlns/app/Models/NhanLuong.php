...
class NhanLuong extends Model
{
    ...
    public function tinhluong($nhanvien_id, $ngaycongchuan, $month, $year)
    {
        ...
        $arr['thue'] = 0;
        if ($arr['thuclinh'] <=5000000) {
            $arr['thue'] = $arr['thuclinh'] * 0.05;
            $arr['thuclinh'] -= $arr['thue'];
        }
        else if($arr['thuclinh'] >5000000 && $arr['thuclinh'] <=10000000){
            $arr['thue'] = $arr['thuclinh'] * 0.1;
            $arr['thuclinh'] -= $arr['thue'];
        }
        else if($arr['thuclinh'] >10000000 && $arr['thuclinh'] <=18000000){
            $arr['thue'] = $arr['thuclinh'] * 0.15;
            $arr['thuclinh'] -= $arr['thue'];
        }
        else if($arr['thuclinh'] >18000000 && $arr['thuclinh'] <=32000000){
            $arr['thue'] = $arr['thuclinh'] * 0.2;
            $arr['thuclinh'] -= $arr['thue'];
        }
        else if($arr['thuclinh'] >32000000 && $arr['thuclinh'] <=52000000){
            $arr['thue'] = $arr['thuclinh'] * 0.25;
            $arr['thuclinh'] -= $arr['thue'];
        }
        else if($arr['thuclinh'] >52000000 && $arr['thuclinh'] <=80000000){
            $arr['thue'] = $arr['thuclinh'] * 0.3;
            $arr['thuclinh'] -= $arr['thue'];
        }
        else{
            $arr['thue'] = $arr['thuclinh'] * 0.35;
            $arr['thuclinh'] -= $arr['thue'];
        }
