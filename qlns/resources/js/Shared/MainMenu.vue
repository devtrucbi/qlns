  ...
  <div>
    ...
    <div v-if="$page.props.auth.user.role == 2" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('heso')">
        ...
        <div :class="isUrl('heso') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Hệ Số</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role == 2" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('phucap')">
        ...
        <div :class="isUrl('phucap') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Phụ Cấp</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('ungluong')">
        ...
        <div :class="isUrl('ungluong') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Ứng Lương</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('baohiem')">
        ...
        <div :class="isUrl('baohiem') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Bảo Hiểm</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('hopdong')">
        ...
        <div :class="isUrl('hopdong') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Hợp Đồng</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('nghiviec')">
        ...
        <div :class="isUrl('nghiviec') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Nghỉ Việc</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('thuongphat')">
        ...
        <div :class="isUrl('thuongphat') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Thưởng Phạt</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('khautru')">
        ...
        <div :class="isUrl('khautru') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Khẩu Trừ</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role == 2" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('bangchamcong')">
        ...
        <div :class="isUrl('bangchamcong') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Chấm Công</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('nhanluong')">
        ...
        <div :class="isUrl('nhanluong') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Nhận Lương</div>
      </inertia-link>
    </div>
    <div v-if="$page.props.auth.user.role > 0" class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('nhanvien')">
        ...
        <div :class="isUrl('nhanvien') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">QL.Nhân Viên</div>
      </inertia-link>
    </div>
  </div>
</template>
